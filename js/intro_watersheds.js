    ...
    var colorsRange = ['#333399', '#993333', '#993399'];
    var sheds = ['./data/intro_all_watersheds/lulc_4_M.tif', './data/intro_all_watersheds/lulc_4_S.tif',
        './data/intro_all_watersheds/lulc_4_TC.tif'];
    var bitmaps  = [];
