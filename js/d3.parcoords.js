...
//CHAB BLOCK
    ...
    function goBackInHistory(index) {
        brushUpdated(prout[index]);
        // we need to update the
    }

    function updateBrush(brushPassed) {
        // you can grab  the bruhs extent here  ----> D.pc.brushExtents

        // the key of this object is the name of the axis
        // the value is a [min, max] array

        // you can tweak the object, like this  :
        // var a = D.pc.brushExtents;
        // a['power (hp)'] = [20, 200]

        // then you pass it here, it's a dirty hack
        D.pc.brushExtents(a);
    }
//
...
(function() {
  ...
  function brushFor(axis) {
	...
	function install() {
		...
		// pc does the job of graphical rendering
		D.pc = pc;
		D.brushExtents = brushExtents;
